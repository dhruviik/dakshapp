...
const Hospital = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
          ...
          // Pass the hospital name to the next page using the state in navigate
          navigate('/hospital/option', { state: { hospitalName: formData.name } });
      } catch (error) {
            ...
            <Container fluid className="d-flex justify-content-between align-items-center py-2">
                ...
                <h2 className='text-center'>Join Us Now</h2>
                    ...
                    <div className="footer-group">
                        <span>Already Registered? <Link to={"/hospital/login"}>Sign In</Link></span>
